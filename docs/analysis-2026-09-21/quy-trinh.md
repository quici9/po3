...
- Dùng được trong Bar Replay: mọi mốc "hiện tại" lấy theo nến cuối trên chart (`last_bar_time`), nên khi replay một ngày cũ vẫn thấy killzone, mức H/L, setup và bảng đối chiếu của 10 ngày quanh ngày đó; alert không chạy trong replay.
