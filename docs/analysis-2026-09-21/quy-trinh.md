...
- Đỉnh/đáy giờ trước vẽ bằng đường chấm từ nến tạo đỉnh/đáy đến hết giờ setup (bật mặc định). Lớp debug (tắt mặc định): điểm quét, lý do bỏ, bảng đối chiếu 10 ngày và Pine Logs, mỗi giờ một dòng.
